...
function chartjsLineChartForcast(
  selector,
  label = "",
  startGradient = "#14345b12",
  endGradient = "#14345b02",
  bColor = "#20C997",
      ...
      var chart = new Chart(elm, {
        ...
        data: {
          ...
          datasets: [{
            ...
            // backgroundColor: bgColor,
            borderColor: bColor,
            pointHoverBackgroundColor: "#14345b",
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
            data: dataG,
            backgroundColor: "#14345b80",
            hoverBackgroundColor: "#14345b",
            label: "Gained",
          },
          // {
          //   data: dataL,
...
chartJsBarChartThree("mychart8", "#14345b20", "#14345b", "Order");
...
chartJsBarChartFour("mychart13", "#14345b20", "#14345b", "New Deals");
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          data: data,
          backgroundColor: ["#20C997", "#14345b", "#FA8B0C"],
          total: "9,283",
        }, ],
      },
      options: {
